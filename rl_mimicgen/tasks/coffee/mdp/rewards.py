...
def coffee_task_reward(
    ...
    lid_cfg: SceneEntityCfg = SceneEntityCfg("coffee_machine", body_names="coffee_machine_lid_main_joint0"),
    ...
    lid_check = machine.data.joint_pos[:, lid_cfg.body_ids].squeeze(1) < hinge_tolerance
